...
<head>
	...
	<title>Admin Dashboard | <?= htmlspecialchars($gym['name'] ?? 'Gym'); ?></title>
...
<body>
	<?php write_admin_sidebar('dashboard'); ?>
			...
			<div class="card">
				...
				<div class="chart-container">
					<div class="chart-row">
						...
						<span class="chart-count" id="label-starter">0</span>
					</div>
					<div class="chart-row">
	...
	<script type="module" src="<?= BASE_URL ?>GymsManager/frontend/js/admin/dashboard.js"></script>
</body>
