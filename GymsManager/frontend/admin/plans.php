...
<body>
	...
	<div class="main-content">
		...
		<div class="card">
			...
			<div class="toolbar">
				...
				<span class="count">Showing <strong id="plan-count">0</strong> plans</span>
			</div>
	...
	<!-- Scripts -->
	<script type="module" src="<?= BASE_URL ?>GymsManager/frontend/js/admin/plans.js"></script>
</body>
