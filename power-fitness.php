		...
		<section class="facilities">
			...
			<div class="facilities-container">
				<article class="facility-card">
					...
					<img src="./assets/images/cardio-room.png" alt="PowerFitness Cardio Rooms Picture">
				</article>
				<article class="facility-card">
					<h3>Weights Area</h3>
					<p>
					...
					<img src="./assets/images/weights-area.png" alt="PowerFitness Weights Area Picture">
				</article>
				<article class="facility-card">
					<h3>Locker Rooms</h3>
					<p>
					...
					<img src="./assets/images/locker-rooms.png" alt="PowerFitness Locker Rooms Picture">
				</article>
				<article class="facility-card">
					...
					<img src="./assets/images/personal-training-zone.png"
						alt="PowerFitness Personal Training Zone Picture">
				</article>
				<article class="facility-card">
					<h3>Sauna & Steam</h3>
					<p>
					...
					<img src="./assets/images/sauna-steam.png" alt="PowerFitness Sauna and Steam Room Picture">
				</article>
				<article class="facility-card">
					...
					<img src="./assets/images/recovery.png" alt="PowerFitness Recovery and Massage Room Picture">
				</article>
			</div>
		</section>
